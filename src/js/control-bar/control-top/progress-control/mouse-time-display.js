...
class MouseTimeDisplay extends Component {
  ...
  constructor(player, options) {
    ...
    if (options.playerOptions &&
        ...
        options.playerOptions.controlBar.controlTop &&
        options.playerOptions.controlBar.controlTop.progressControl &&
        options.playerOptions.controlBar.controlTop.progressControl.keepTooltipsInside) {
      this.keepTooltipsInside = options.playerOptions.controlBar.controlTop.progressControl.keepTooltipsInside;
    }
    ...
    player.on('ready', () => {
      this.on(player.controlBar.controlTop.progressControl.el(), 'mousemove', throttle(Fn.bind(this, this.handleMouseMove), 25));
    });
  }
